...
function normalizePersonalization(p: any, cur: any): Personalization {
    ...
    return {
        ...
        colors: {
            sidebar: str(colorsIn.sidebar, '#00000066'),
            modal: str(colorsIn.modal, '#0b0b0b'),
            buttons: str(colorsIn.buttons, '#2b2b3d'),
            borderModal: str(colorsIn.borderModal, '#131313'),
            border: str(colorsIn.border, '#131313'),
            progress: str(colorsIn.progress, '#5ed89a'),
            playButton: str(colorsIn.playButton, '#1f1f1f'),
            buttonPrimary: str(colorsIn.buttonPrimary, '#19191a'),
            error: str(colorsIn.error, '#ff6b6b'),
            success: str(colorsIn.success, '#34d399'),
            tag: str(colorsIn.tag, '#a974ff'),
            warning: str(colorsIn.warning, '#fbbf24'),
        },
