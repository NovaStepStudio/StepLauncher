...
const colorSidebar = ref('#00000066');
const colorModal = ref('#0b0b0b');
const colorBorderModal = ref('#131313');
const colorBorder = ref('#131313');
const colorProgress = ref('#5ed89a');
const colorError = ref('#ff6b6b');
const colorSuccess = ref('#34d399');
const colorTag = ref('#a974ff');
const colorWarning = ref('#fbbf24');
const colorPlayButton = ref('#1f1f1f');
const colorButtonPrimary = ref('#19191a');
...
onMounted(async () => {
    try {
        ...
        const c = p.colors ?? {};
        colorSidebar.value = c.sidebar ?? '#00000066';
        colorModal.value = c.modal ?? '#0b0b0b';
        colorBorderModal.value = c.borderModal ?? '#131313';
        colorBorder.value = c.border ?? '#131313';
        colorProgress.value = c.progress ?? '#5ed89a';
        colorError.value = c.error ?? '#ff6b6b';
        colorSuccess.value = c.success ?? '#34d399';
        colorTag.value = c.tag ?? '#a974ff';
        colorWarning.value = c.warning ?? '#fbbf24';
        colorPlayButton.value = c.playButton ?? '#1f1f1f';
        colorButtonPrimary.value = c.buttonPrimary ?? '#19191a';
